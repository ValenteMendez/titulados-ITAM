...
st.markdown("<h6 style='text-align: left; color: #666; font-style: italic; margin-bottom: 30px;'>Non-official dashboard made with publicly available information.</h6>", unsafe_allow_html=True)
